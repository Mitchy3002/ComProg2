...
public class EmployeeDetailsFrame extends EmployeeDetailsBaseFrame {
    ...
    public EmployeeDetailsFrame(String[] employeeDetails, PayrollSystem payrollSystem) {
        ...
        gbc.gridy = 20; // Ensure it's in the 20th row
    ...
    private void onSaveButtonClicked() {
        ...
        // Replace the old file with the updated file using NIO
        try {
            Files.move(tempFile.toPath(), Paths.get(EMPLOYEE_DATA_FILE), java.nio.file.StandardCopyOption.REPLACE_EXISTING);
        } catch (IOException e) {
